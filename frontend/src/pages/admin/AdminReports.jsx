            ...
            <div className="border-t border-white/10 mt-4 pt-6 flex flex-wrap gap-4 items-center justify-between">
                ...
                <div className="flex gap-3">
                    <button 
                        ...
                        className="bg-red-500/20 text-red-300 border border-red-500/30 hover:bg-red-500/30 px-6 py-2.5 rounded-xl font-bold  disabled:opacity-50 min-w-35"
                    >
                    ...
                    <button 
                        ...
                        disabled={isExporting}
                        className="bg-green-500/20 text-green-300 border border-green-500/30 hover:bg-green-500/30 px-6 py-2.5 rounded-xl font-bold  disabled:opacity-50 min-w-35"
                    >
                    ...
                    <button 
                        ...
                        disabled={isExporting}
                        className="bg-white/10 text-white border border-white/20 hover:bg-white/20 px-6 py-2.5 rounded-xl font-bold  disabled:opacity-50 min-w-35"
                    >
