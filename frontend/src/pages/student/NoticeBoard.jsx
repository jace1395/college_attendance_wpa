...
const NoticeBoard = () => {
  ...
  // Mock Messages
  const messages = [
    { id: 1, sender: "Principal Office", subject: "Holiday Tomorrow", body: "Please be informed that tomorrow is a holiday.", time: "10:30 AM", type: 'inbox', read: false },
    { id: 2, sender: "Sumit Kumar", subject: "Assignment 3 Deadline", body: "The deadline for Assignment 3 is extended to Friday.", time: "Yesterday", type: 'inbox', read: true },
    { id: 3, sender: "Admin", subject: "System Maintenance", body: "The attendance portal will be down for maintenance.", time: "Aug 20", type: 'inbox', read: true },
    { id: 4, sender: "Me", subject: "Leave Application", body: "I am unwell today and cannot attend classes.", time: "Aug 15", type: 'sent' }
  ];
      ...
      <div className="relative z-10 p-4 md:p-8 max-w-7xl mx-auto h-screen flex flex-col">
        ...
        <div className="flex items-center justify-between mb-6 shrink-0">
          <div className="flex items-center gap-4">
            <Link to="/student/dashboard" className="text-blue-400 hover:text-blue-300">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path></svg>
            </Link>
            <h1 className="text-2xl font-bold">Notices</h1>
          </div>
          <div className="bg-slate-800/50 backdrop-blur-md border border-white/10 rounded-xl px-4 py-2 text-sm text-white/70">
            {user?.email}
          </div>
        </div>
