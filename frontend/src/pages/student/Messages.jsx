...
const INITIAL_THREADS = {
  mentor: [
    { id: 1, from: "me",     text: "Good morning ma'am, I wanted to ask about my attendance shortage.", time: "Yesterday 10:12 AM" },
    { id: 2, from: "contact",text: "Good morning! Yes, please see me after the lecture at 12pm.", time: "Yesterday 10:15 AM" },
  ],
  teacher: [
    { id: 1, from: "contact",text: "Please submit your assignments before Friday.", time: "Mon 9:00 AM" },
  ],
  hod: [],
};
    ...
    <div className="min-h-screen bg-slate-900 text-white flex flex-col">
      ...
      <div className="px-6 py-4 border-b border-white/10 flex items-center justify-between bg-slate-900/80 backdrop-blur-xl sticky top-0 z-10">
        ...
        <div className="flex gap-3">
          <Link to="/student/dashboard" className="px-3 py-1.5 bg-white/5 hover:bg-white/10 rounded-lg border border-white/10 text-xs font-medium transition-colors">Dashboard</Link>
      ...
      <div className="flex flex-1 overflow-hidden max-w-5xl mx-auto w-full px-6 py-6 gap-5">
        ...
        <div className="flex-1 flex flex-col bg-white/5 border border-white/10 rounded-2xl overflow-hidden shadow-xl">
          ...
          {activeContact === "teacher" ? (
            <div className="px-5 py-4 border-t border-white/10 flex items-center justify-center bg-slate-900/50">
              <p className="text-sm text-white/40 font-medium flex items-center gap-2">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg>
                Replies are disabled for teacher announcements
              </p>
            </div>
          ) : (
