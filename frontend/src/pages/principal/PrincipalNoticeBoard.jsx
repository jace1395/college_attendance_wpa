        ...
        <div className="flex-1 bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl overflow-hidden flex flex-col shadow-xl">
            ...
            <div className="overflow-y-auto flex-1 p-2">
                ...
                >
                    ...
                    {msg.isMonitoring ? (
                        <div className="block md:inline bg-blue-500/10 text-blue-300 text-xs px-2 py-1 rounded border border-blue-500/20 ml-0 md:ml-2 mt-2 md:mt-0">
                            {msg.classDetails} • {msg.timeSlot} • <strong className="text-white">{msg.body}</strong>
                        </div>
                    ) : (
