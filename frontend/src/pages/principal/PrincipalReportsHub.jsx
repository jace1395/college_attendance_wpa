...
const StatCard = ({ label, value, icon, colorClass, accent }) => (
  <div
    className={"flex flex-col gap-2 rounded-2xl p-5 border " + colorClass + " flex-1 min-w-[120px] relative overflow-hidden"}
    ...
    <div className="flex flex-col gap-5 animate-fade-in-up">
      ...
      <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl px-5 pt-4 pb-5 shadow-xl">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4">
          <StatCard label="Total Enrolled" value={totalEnrolled} colorClass="bg-purple-500/10 border-purple-500/30" accent="#8b5cf6"
