...
import MonitoringTab from '../../components/teacher/MonitoringTab';
        ...
        setTimeout(() => {
          const mockData = {
            ...
            "daily_timetable": [
              ...
              {
                // This mock ensures Smart Open triggers often for testing (checks if current time is within this broad range)
                "time_start": "00:00",
                "time_end": "23:59",
                "subject": "System Test Class",
                "class_id": "BVC_TEST",
                "room": "Virtual"
              }
            ],
          ...
          const ongoingClass = mockData.daily_timetable.find(c => {
