...
const TeacherNoticeBoard = () => {
  ...
  // Mock Messages
  const messages = [
    { id: 1, sender: "Principal Office", subject: "Urgent Meeting", body: "Please gather in the staff room.", time: "10:30 AM", type: 'inbox', read: false },
    { id: 2, sender: "Admin", subject: "System Maintenance", body: "Portal down at 6 PM.", time: "Yesterday", type: 'inbox', read: true },
    { id: 3, sender: "Me", subject: "Syllabus Update", body: "Attached is the new syllabus.", time: "Aug 15", type: 'sent' }
  ];
  ...
  const filteredMessages = messages
    ...
    .filter(m => {
        ...
        if (activeFilter === 'From Principal') return m.sender === 'Principal Office';
        return true;
    });
        ...
        <div className="flex-1 bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl overflow-hidden flex flex-col shadow-xl">
            ...
            <div className="p-4 border-b border-white/10 flex flex-wrap justify-between items-center bg-slate-900/40 gap-4">
                ...
                <div className="flex gap-2 overflow-x-auto pb-1 md:pb-0">
                    {['All', 'Unread', 'From Principal'].map(f => (
                        <button 
                            key={f}
                    ...
                    <div className="p-6 flex flex-col gap-4">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-start border-b border-slate-700 pb-2 relative z-50">
                            ...
                            <div className="flex-1 flex flex-wrap gap-2">
                                {selectedTo.map(r => (
                                    <span key={r} className="bg-blue-500/20 text-blue-300 border border-blue-500/30 px-2 py-1 rounded-md text-xs flex items-center gap-1">
                                        {r}
